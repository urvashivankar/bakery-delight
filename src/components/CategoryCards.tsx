          ...
          {categories.map((category, index) => (
            <Link href="/menu" key={category.name} className="block">
              <motion.div
                ...
                className="group relative h-40 md:h-48 lg:h-56 rounded-[2rem] overflow-hidden cursor-pointer shadow-lg shadow-bakery-pink/10 hover:shadow-2xl hover:shadow-[#DE9BA9]/40 hover:-translate-y-3 transition-all duration-500 hover-target border border-white/60"
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-bakery-chocolate/80 via-transparent to-transparent z-20" />
