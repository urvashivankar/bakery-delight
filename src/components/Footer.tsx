...
export function Footer() {
  ...
  return (
    <footer id="footer" className="bg-white pt-32 pb-12 relative overflow-hidden border-t border-bakery-pink/20">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        {/* Newsletter Section */}
        <div className="bg-bakery-bg rounded-[3rem] p-12 md:p-16 mb-24 shadow-xl flex flex-col md:flex-row items-center justify-between gap-12 border border-bakery-pink/20">
          <div className="md:w-1/2">
            <h3 className="font-heading text-4xl md:text-5xl text-bakery-chocolate font-bold mb-4">
              Join Our Sweet Club
            </h3>
            <p className="font-sans text-lg text-bakery-chocolate/70">
          ...
          <div className="md:w-1/2 w-full">
            <form className="flex w-full relative" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="w-full bg-white border border-bakery-pink/30 rounded-full px-8 py-5 pr-40 text-bakery-chocolate focus:outline-none focus:border-[#DE9BA9] transition-colors font-sans"
              />
              <button 
                type="submit" 
                className="absolute right-2 top-2 bottom-2 bg-[#DE9BA9] text-white px-8 rounded-full font-sans font-bold uppercase tracking-widest shadow-md hover:bg-bakery-chocolate transition-colors hover-target text-sm"
              >
                Subscribe
              </button>
            </form>
